<template>
  <footer>
    <section class="flex flex-col lg:flex-row justify-around items-center lg:items-start pt-20 px-10 bg-slate-950 pb-10 gap-5">

      <section class="w-4/5 flex flex-row lg:flex-col gap-5 lg:h-[470px] items-start justify-between lg:justify-around">
        <section class="flex flex-col gap-3 w-2/5 lg:w-full">
          <h3 class="text-3xl">
            Program de lucru:
          </h3>
          <ul class="flex flex-col gap-2">
            <li><p>Luni: 8:00 - 17:00</p></li>
            <li><p>Marti: 8:00 - 17:00</p></li>
            <li><p>Miercuri: 8:00 - 17:00</p></li>
            <li><p>Joi: 8:00 - 17:00</p></li>
            <li><p>Vineri: 8:00 - 17:00</p></li>
            <li><p>Sambata: 8:00 - 13:00</p></li>
          </ul>
        </section>
      ...
      <div class="w-4/5 overflow-x-hidden">
        <iframe
            ...
            class="w-full"
        />
        <p> Str. George Calinescu Nr.3, Iasi, Romania</p>
      </div>
